        ...
        <div className='abilities-box'>
          ...
          <div className='abibox-content'>
            <div className='abibox-content-info'>
              ...
              <p className='abibox-content-text'>아이콘, 일러스트, 그래픽 제작</p>
            </div>
            <div className='abibox-content-info'>
              <p className='abibox-content-program'>FIGMA</p>
              <p className='abibox-content-text'>웹 디자인, 프로토타입</p>
            </div>
            <div className='abibox-content-info'>
              <p className='abibox-content-program'>Ant Design, Bootstrap</p>
              <p className='abibox-content-text'>앤트 디자인, 부트스트랩 활용</p>
            </div>
            <div className='abibox-content-info'>
        ...
        <div className='abilities-box'>
          ...
          <div className='abibox-content'>
            ...
            <div className='abibox-content-info'>
              ...
              <p className='abibox-content-text'>안정적인 크로스 브라우징을 위한 position과 float 사용 능숙, flex를 활용한 레이아웃 작업 또한 가능</p>
            </div>
            <div className='abibox-content-info'>
        ...
        <div className='abilities-box'>
          ...
          <div className='abibox-content'>
            ...
            <div className='abibox-content-info'>
              ...
              <p className='abibox-content-text'>각종 React Hook을 활용한 유연한 개발</p>
            </div>
            <div className='abibox-content-info'>
              <p className='abibox-content-program'>VUE</p>
              <p className='abibox-content-text'>props, emit, v-if, v-for 등 vue 개발 가능</p>
            </div>
            <div className='abibox-content-info'>
              <p className='abibox-content-program'>NODE JS</p>
              <p className='abibox-content-text'>node js의 express 라이브러리를 통해 환경 구축 후, sqlite를 사용해 데이터 베이스 생성. 해당 데이터를 활용한 풀스택 프로젝트 진행</p>
            </div>
          </div>
        </div>
      </div>
